...
protected:
  ...
  ros::Subscriber chatter_sub_ur5_joint_states;
...
public:
    ...
    double servoj_time = 0.008;
      ...
      robot_.uploadProg();
      chatter_sub_ur5_joint_states = nh_.subscribe("/ur5_jointstates",1000, &RosWrapper::ChatterCallBack_JointStates, this);
		}
	}
...
private:
  ...
  void ChatterCallBack_JointStates(const sensor_msgs::JointState::ConstPtr& jointpositon_msg ) {

    robot_.servoj(jointpositon_msg->position);
  }
